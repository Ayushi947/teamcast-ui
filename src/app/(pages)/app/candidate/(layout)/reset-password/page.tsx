...
export default function ResetPasswordPage() {
  ...
  const changePartnerPasswordMutation = useMutation({
  ...
  const changeCandidatePasswordMutation = useMutation({
    mutationFn: (data: { currentPassword: string; newPassword: string }) =>
  ...
  const handlePasswordUpdate = async () => {
    ...
    try {
      if (isPartnerResource) {
        await changePartnerPasswordMutation.mutateAsync({
          currentPassword,
          newPassword,
        });
      } else {
        await changeCandidatePasswordMutation.mutateAsync({
          currentPassword,
          newPassword,
        });
      }
  ...
  const isLoading = changePartnerPasswordMutation.isPending;

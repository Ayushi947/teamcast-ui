...
const SupportTicketsPage = () => {
  ...
  const [categoryFilter, setCategoryFilter] = useState<
    (SupportCandidateTicketCategoryEnum | 'ALL')[]
  >(['ALL']);
  ...
  const handleViewTicket = (ticket: ISupportTicketListItemResponse) => {
    router.push(`/app/candidate/support-tickets/${ticket.id}`);
  };
  ...
  const filters: SaasTableFilter[] = [
    ...
    },
    {
      ...
      onChange: (value) => {
        if (Array.isArray(value)) {
          setCategoryFilter(
            value as (SupportCandidateTicketCategoryEnum | 'ALL')[]
          );
        } else {
          setCategoryFilter([
            value as SupportCandidateTicketCategoryEnum | 'ALL',
      ...
      options: [
        ...
        ...Object.values(SupportCandidateTicketCategoryEnum).map(
          (category) => ({
            label: formatEnumValue(
              category as SupportCandidateTicketCategoryEnum
            ),
            value: category,
          })
        ),

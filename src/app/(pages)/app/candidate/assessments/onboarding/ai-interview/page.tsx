...
import type { ICandidateOnboardingAssessment } from '@/lib/shared';
...
const logAIInterviewTelemetry = (
  ...
  const message = `[AI_INTERVIEW] ${event}`;
...
function AIInterviewPageContent() {
  ...
  const videoRecordingEnabled =
    assessment.onboardingAssessmentSettings?.videoRecordingEnabled || false;
...
function InterviewSessionWithLiveKit({
  ...
  assessmentId: string;
  assessment: ICandidateOnboardingAssessment | null;

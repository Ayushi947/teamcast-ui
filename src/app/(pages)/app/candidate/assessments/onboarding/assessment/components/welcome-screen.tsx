...
import { FEATURE_FLAGS } from '@/lib/shared';
...
export function WelcomeScreen({
  ...
  const faceDetectionFromFlags = useFeature(
    FEATURE_FLAGS.FACE_DETECTION_ENABLED
  );
  const faceDetectionEnabled = faceDetectionFromFlags ?? false;
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-text-secondary text-sm">
                      Please note that your AI Interview recording will be
                      securely stored and available in your profile.
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <span className="bg-primary/20 text-primary flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-sm font-medium">

...
import { UsersList } from '@/app/(pages)/app/client/(layout)/users/components/users-list';
import { InvitationsList } from '@/app/(pages)/app/client/(layout)/users/components/invitations-list';
  ...
  return (
    ...
    >
      <UsersHeader
        ...
        userRole={userRole || ''}
        canInviteUsers={usageSummary?.seats.canAdd || false}
      />

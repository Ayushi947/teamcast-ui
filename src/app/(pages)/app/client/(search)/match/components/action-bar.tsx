...
export const ActionBar = ({
  ...
  if (selectedCandidatesCount === 0) return null;

  const handleProceed = () => {
    if (isLoggedIn) {
      router.push('/app/client/search/next');
    } else {
      ...
      >
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          <div className="text-sm text-gray-600 dark:text-gray-300">
            {selectedCandidatesCount} candidates selected
          </div>
        ...
        <DialogContent className="overflow-hidden p-0 sm:max-w-md">
          <div className="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-7 text-white">
            ...
            <p className="mt-2 text-sm font-medium text-white/90">
              Connect with {selectedCandidatesCount} selected candidates and
              schedule interviews
            </p>
          </div>
          ...
          <div className="p-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-sm">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">
                    Direct contact with top candidate
                  </span>
                </li>
                <li className="flex items-center gap-3 text-sm">
                  <div className="bg-primary/10 text-primary dark:bg-primary/10 dark:text-primary flex h-6 w-6 items-center justify-center rounded-full">
            ...
            <div className="space-y-4">
              <Button
                onClick={() => router.push('/app/client/signup')}

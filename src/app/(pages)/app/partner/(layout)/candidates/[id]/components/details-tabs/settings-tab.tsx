...
import { IPartnerCandidateDetailed, CandidateStatusEnum } from '@/lib/shared';
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center justify-between rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                    ...
                    <Badge
                      className={`${
                        candidate.isPublished ? 'bg-green-500' : 'bg-gray-500'
                      } text-white`}
                    >
                      {candidate.isPublished ? 'Visible' : 'Hidden'}
                    </Badge>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                    ...
                    <Badge className="bg-[#6e55cf] text-white">
                      {formatEnumValue(candidate.jobSearchStatus || 'UNKNOWN')}
                    </Badge>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    Get notified about partner-related updates
                  </p>
                </div>
                <Badge className="bg-green-500 text-white">Enabled</Badge>
              </div>

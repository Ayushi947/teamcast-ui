...
export function AccountManagerClientsList() {
  ...
  const handleViewClient = (clientId: string) => {
    ...
    router.push(`/app/support/clients/${clientId}`);
  };
    ...
    <div className="space-y-6 p-4">
      ...
      <SaasDataTable<ISupportClientListResponse>
        ...
        emptyState={{
          ...
          description: "You don't have any clients assigned to you yet",
        }}

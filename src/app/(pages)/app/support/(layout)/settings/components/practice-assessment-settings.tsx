...
const DEFAULT_SAMPLE_TEXT = {
  ENGLISH:
    'Welcome to your practice assessment. Please listen carefully to each question and provide thoughtful responses.',
};
...
interface PracticeAssessmentSettingsDialogProps {
  open: boolean;
...
export function PracticeAssessmentSettingsDialog({
  open,
  onOpenChange,
  initialValues,
  isLoading: _isLoading = false,
  onSave,
}: PracticeAssessmentSettingsDialogProps) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      maxSections: initialValues?.maxSections || 3,
            ...
            >
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure the voice settings for practice assessments.
                  </CardDescription>
                </CardHeader>

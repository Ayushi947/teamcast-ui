...
interface OnboardingAssessmentGlobalSettingsDialogProps {
  open: boolean;
...
export function OnboardingAssessmentGlobalSettingsDialog({
  open,
  onOpenChange,
  initialValues,
  isLoading: _isLoading = false,
  onSave,
}: OnboardingAssessmentGlobalSettingsDialogProps) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      maxSections: initialValues?.maxSections || 6,
      maxQuestionsPerSection: initialValues?.maxQuestionsPerSection || 8,
      ...
      minimumVideoLength: initialValues?.minimumVideoLength || 10,
      aiVideoAnalysisEnabled: initialValues?.aiVideoAnalysisEnabled ?? true,
      autoPublishOnSuccess: initialValues?.autoPublishOnSuccess ?? true,
      ...
      <DialogContent className="max-h-[90vh] max-w-5xl overflow-hidden">
        <DialogHeader className="border-b pb-4">
          <DialogTitle className="flex items-center gap-2 text-xl">
            ...
            Onboarding Assessment Global Settings
          </DialogTitle>
        </DialogHeader>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            {...field}
                            placeholder="SKILLS_ASSESSMENT, PERSONALITY_ASSESSMENT"
                          />
                        </FormControl>
                        <FormDescription>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Minimum Video Length (minutes)</FormLabel>
                          <FormControl>
                            <Input
                              type="number"
                              {...field}

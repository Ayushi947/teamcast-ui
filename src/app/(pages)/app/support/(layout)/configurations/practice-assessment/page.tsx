...
export default function PracticeAssessmentConfigurationPage() {
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-cyan-100 dark:bg-cyan-900/30">
            <ClipboardCheck className="h-5 w-5 text-cyan-600 dark:text-cyan-400" />
          </div>
          <div>
            <h1 className="text-foreground text-2xl font-bold tracking-tight">
              Practice Assessment Configuration
            </h1>
            <p className="text-muted-foreground">
              Configure global settings for practice assessments
            </p>
          </div>
        </div>
      </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="TECHNICAL, BEHAVIORAL" />
                    </FormControl>
                    <FormDescription>

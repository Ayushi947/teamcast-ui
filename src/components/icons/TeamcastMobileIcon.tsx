...
const TeamcastMobileIcon = ({
  ...
  const effectivePrimaryColor =
    primaryColor ?? (isAuthPage || isDarkMode ? '#ffffff' : '#121212');
  const effectiveSecondaryColor =
    secondaryColor ?? (isAuthPage || isDarkMode ? '#ffffff' : '#6E55CF');
...
export default TeamcastMobileIcon;

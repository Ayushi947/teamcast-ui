...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'text-foreground',
      'dark:focus:bg-accent/50 dark:data-[state=open]:bg-accent/50',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      'dark:border-input/20 dark:bg-background/95',
      className
    )}
    {...props}
  />
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'border-input bg-background z-50 min-w-[8rem] overflow-hidden rounded-md border p-1 shadow-md',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'text-foreground',
      'dark:focus:bg-accent/50 dark:focus:text-accent-foreground',
      inset && 'pl-8',
      className
    )}
    {...props}
